...
sudo chown -R ${AWS_EC2_USER}: /var/www/certbot
sudo chown -R ${AWS_EC2_USER}: /etc/letsencrypt
sudo chown -R ${AWS_EC2_USER}: /etc/letsencrypt/live
sudo chown -R ${AWS_EC2_USER}: /etc/letsencrypt/live/${PRIMARY_DOMAIN_NAME}
